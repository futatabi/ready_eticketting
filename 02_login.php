...
<html lang="en">
<head>
<title>Login - Ready (Reva & Afandy) E-Tiket & Transportasi - We Trust in Quality Services of Transportation</title>
...
<body>
	...
	<div class="page-header" data-stellar-background-ratio="0.4">
		...
		<div class="container">
	<!-- FORM -->
			<form style="padding:40px" action="cek.php" method="post">
				<div class="form-group">
					<label>Alamat Email</label>
					<input type="email" class="form-control" name="email" placeholder="Alamat Email" required="required" autofocus>
					</div>
				
				<div class="form-group">
					<label>Password</label>
					 <input type="password" class="form-control" class="form-control" name="sandi" placeholder="Password" required="required">
					</div>
				<br>
				<button type="submit" value="Login" name="login" id="btn-daftar" class="btn btn-primary">MASUK</button>
	  Belum punya akun? <a href="09_signup.php">Daftar Yuk!</a>
                    </form>
